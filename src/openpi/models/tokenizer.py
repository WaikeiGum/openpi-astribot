...
# class FASTTokenizer:
#     def __init__(self, max_len: int = 280, fast_tokenizer_path: str = "tokenizers_ckpt/double_grasp_hor_32"):
#         self._max_len = max_len # TBD: change it to 280
...
#         # Instantiate FAST tokenizer
#         # self._fast_tokenizer = AutoProcessor.from_pretrained(fast_tokenizer_path, trust_remote_code=True)
#         self._fast_tokenizer = AutoProcessor.from_pretrained("physical-intelligence/fast", trust_remote_code=True).from_pretrained(fast_tokenizer_path)
#         self._fast_skip_tokens = 128  # Skip last 128 tokens in PaliGemma vocab since they are special tokens
