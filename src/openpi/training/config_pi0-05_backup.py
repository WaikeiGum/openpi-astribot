...
_CONFIGS = [
    ...
    #
    # TrainConfig(
    #     name="pi_0_diversity_partial_1",            
    #     data=LeRobotS1DataConfig(
    #         use_so3 = [True,True],
    #         multi_rerobot=True,
    #         repo_id = ['0826_pretrain_clean_pen_s1_19', '0827_pretrain_clean_pen_s1_19', '0901_microwave_s1_19',
    #             '20250916_change_tissues_s1_5', '20250917_Insert_pen_s1_5', '20250917_change_tissues_s1_5', 
    #             '20250918_place_in_cake_into_microwave_s1_19', '20250919_Insert_pen_s1_5', '20250919_change_tissues_s1_5',
    #             '20250919_place_in_cake_into_microwave_s1_19', '20250923_place_in_cake_into_microwave_s1_19',
    #             '0829_microwave_s1_19', '20250904_Change_tissues_s1_19', '20250905_make_oatmeal_s1_19', 
    #             '20250906_make_oatmeal_s1_19', '20250919_pnp_basketball_big_s1_10'],

    #         # repo_id = ['0826_pretrain_clean_pen_s1_19'],                

    #         dataset_root = "/kpfs-regular/share_space/data/lerobot_data_aliyun/s1_data/diversity_partial/",
    #         norm_state_path='/kpfs-cognition/waikei/codes/openpi-uncle/assets/pi_0_diversity_partial_1/norm_stats.json',
    #         adapt_to_pi=False,
    ...
    #                 "/kpfs-regular/baifu/openpi/openpi-assets/checkpoints/pi0_base/params"
    #                 ), 
    #     num_train_steps=56000,                                                                                # 890847 * 20 / 320 = 55677.9375
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=56000),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    # ),
    # TrainConfig(
    #     name="pi_0_make_oat_meal",            
    #     data=LeRobotS1DataConfig(
    #         use_so3 = [True,True],
    #         multi_rerobot=True,
    #         repo_id = ['20250905_make_oatmeal_s1_19', '20250906_make_oatmeal_s1_19'],                                               # num_frames: 183365 + 60577 = 243942
    #         dataset_root = "/kpfs-regular/share_space/data/lerobot_data_aliyun/s1_data/diversity_partial/",
    #         norm_state_path='/kpfs-cognition/waikei/codes/openpi-uncle/assets/pi_0_diversity_partial_1/norm_stats.json',
    #         adapt_to_pi=False,
    #         repack_transforms = _transforms.Group(
    ...
    #                 "/kpfs-regular/baifu/openpi/openpi-assets/checkpoints/pi0_base/params"
    #                 ), 
    #     num_train_steps=16_000,                                                                                                # 243942 frames * 20 epochs / 40*8 bs = 15247 steps >> 16000 steps
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=16_000),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    # ),
    # TrainConfig(
    #     name="pi_0_change_tissue",            
    #     data=LeRobotS1DataConfig(
    #         use_so3 = [True,True],
    #         multi_rerobot=True,
    #         repo_id = ['20250904_Change_tissues_s1_19', '20250916_change_tissues_s1_5', '20250916_Change_tissues_s1_26',
    #             '20250917_change_tissues_s1_5', 
    #             '20250919_change_tissues_s1_5'],                                                                            # num_frames: 161924 + 155775 + 141153 + 174605 + 66496 = 699953
    ...
    #                 "/kpfs-regular/baifu/openpi/openpi-assets/checkpoints/pi0_base/params"
    #                 ), 
    #     num_train_steps=44_000,                                                                                                        # 699953 * 20 / 320 = 43748
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=44_000),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    #                 "/kpfs-regular/baifu/openpi/openpi-assets/checkpoints/pi0_base/params"
    #                 ), 
    #     num_train_steps=2_200,                                                                                        # 35022 * 20 / 320 = 2188.875
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=2_200),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    # ),
    # TrainConfig(
    #     name="pi_0_pnp_basketball_small",            
    #     data=LeRobotS1DataConfig(
    #         use_so3 = [True,True],
    #         multi_rerobot=True,
    #         repo_id = [],
    ...
    #                 ), 
    #     num_train_steps=360_000,
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=360_000),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    # ),
    # TrainConfig(
    #     name="pi_0_pen_holder",            
    #     data=LeRobotS1DataConfig(
    #         use_so3 = [True,True],
    #         multi_rerobot=True,
    #         repo_id = ['0826_pretrain_clean_pen_s1_19', '0827_pretrain_clean_pen_s1_19', '20250915_Grab_pen_holder_s1_26', '20250917_Insert_pen_s1_5',
    #             '20250919_Insert_pen_s1_5'],                                                                                                            # 14999 + 92451 + 80636 + 169296 + 70149 = 427531
    ...
    #                 "/kpfs-regular/baifu/openpi/openpi-assets/checkpoints/pi0_base/params"
    #                 ), 
    #     num_train_steps=27_000,                                                                                # 427531 * 20 / 320 = 26720.6875
    #     lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=27_000),
    #     batch_size=40*8,
    #     num_workers=32,
    #     wandb_enabled=True,
    #     log_interval=100,
    ...
    #
    TrainConfig(
        name="pi_05_diversity_partial_1",            
        data=LeRobotS1DataConfig(
            use_so3 = [True,True],
            multi_rerobot=True,
            repo_id = ['0826_pretrain_clean_pen_s1_19', '0827_pretrain_clean_pen_s1_19', '0901_microwave_s1_19',
    ...
    TrainConfig(
        ...
        num_train_steps=69600,                                                                                # 890847 * 20 / 32 / 8 = 69597.421875
    ...
    TrainConfig(
        ...
        num_train_steps=19_100,                                                                                                # 243942 frames * 20 epochs / 32 / 8 bs = 19057.96875 steps >> 19100 steps
        lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=19_100, peak_lr=5e-5, decay_lr=5e-6),
        batch_size=32*8,
        num_workers=32,
        wandb_enabled=True,
        log_interval=100,
    ...
    TrainConfig(
        ...
        num_train_steps=54700,                                                                                                        # 699953 * 20 / 32 / 8 = 54683.828125
        lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=54700, peak_lr=5e-5, decay_lr=5e-6),
        batch_size=32*8,
        num_workers=32,
        wandb_enabled=True,
        log_interval=100,
    ...
    TrainConfig(
        name="pi_05_pnp_basketball_small",            
        data=LeRobotS1DataConfig(
            use_so3 = [True,True],
            multi_rerobot=True,
            repo_id = [],
        ...
        num_train_steps=360_000,
        lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=360_000, peak_lr=5e-5, decay_lr=5e-6),
        batch_size=32*8,
        num_workers=32,
        wandb_enabled=True,
        log_interval=100,
    ...
    TrainConfig(
        ...
        num_train_steps=27_000,                                                                                # 427531 * 20 / 32 / 8 = 26720.6875
        lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=27_000, peak_lr=5e-5, decay_lr=5e-6),
        batch_size=32*8,
        num_workers=32,
        wandb_enabled=True,
        log_interval=100,
    ...
    TrainConfig(
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
                    "/kpfs-cognition/waikei/codes/openpi-uncle/checkpoints/pi05_base/params"
                    ), 
        num_train_steps=2_800,                                                                                        # 35022 * 20 / 32 / 8 = 2736.09375
        lr_schedule=_optimizer.CosineDecaySchedule(decay_steps=2_800, peak_lr=5e-5, decay_lr=5e-6),
        batch_size=32,
